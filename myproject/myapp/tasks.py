...
from myproject.myapp.models import Shop, Category, ProductInfo, Product, Parameter, ProductParameter
from myproject.myproject.celery import celery_app


# from myapp.models import Shop, Category, Product, Parameter, ProductParameter, ProductInfo
